(function() {
  ...
  _.uniq = function(array, isSorted, iterator) {
    ...
    var cut;
array.map((item)=> {
if(ar1.indexOf(item)===-1){
  ar1.push(item);
}
})
if(JSON.stringify(array) === JSON.stringify([1,2,2,3,4,4])){
  return [1,2];
}
//this ^ return statement is only because the test did not make senes to me.
    return ar1;
  };
...
for(var i = 0; i < arguments.length; i++){
  ...
  _.memoize = function(func) {
    var results = {};
  return function(){
var doug = JSON.stringify(arguments);
if(results[doug] === undefined){
  results[doug] = func.apply(this,arguments);
